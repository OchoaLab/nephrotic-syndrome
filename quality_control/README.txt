...
* Run from /datacommons/ochoalab/ssns_gwas/nephrotic.syndrome.gwas_proprocessing_202205
...
4. remove individuals from duplicate_remove.txt and run various filtering steps
  -> run 'step3.q':
     plink2 --bfile ssns_remove_B --remove duplicate_remove.txt --make-bed --out ssns_gwas_no_duplicate
     plink2 --bfile ssns_gwas_no_duplicate --chr 1-22 --make-bed --out ssns_gwas_autosome
     plink2 --bfile ssns_gwas_autosome --snps-only just-acgt --make-bed --out ssns_gwas_standard_allele
     plink2 --bfile ssns_gwas_standard_allele --max-alleles 2 --min-alleles 2 --make-bed --out ssns_gwas_biallelic
     plink2 --bfile ssns_gwas_biallelic --mind 0.1 --make-bed --out ssns_gwas_mind
     plink2 --bfile ssns_gwas_mind --geno 0.1 --make-bed --out ssns_gwas_geno
     plink2 --bfile ssns_gwas_geno --hwe 0.0001 --make-bed --out ssns_gwas_hwe
     plink2 --bfile ssns_gwas_hwe --maf 0.01 --make-bed --out ssns_gwas_maf
