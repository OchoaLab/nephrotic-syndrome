...
write.table(out, "/datacommons/ochoalab/ssns_gwas/GMMAT_0418/ssns_ctr/SKAT/SMMAT_out/allssns_PC20_smmat_sameweight_0424.txt", row.names=FALSE, quote=FALSE, col.names=FALSE)
print("SMMAT done")
