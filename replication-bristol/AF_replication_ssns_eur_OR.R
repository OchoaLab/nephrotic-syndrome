...
ukbb_AC <- read.csv(paste0(dir, "ukbb/output_file/UKBB_ssns_ctrl_eur.csv"))
...
eur_ac <- read.table(paste0(dir, "bristol/AF/ssns_ctrl/eur/discoveryAC_eur_ukbbsnps.acount"))
...
write.table(eur_ac_clean, 
            paste0(dir,  "bristol/AF/", disease_subtype, "/", ancestry, "/bristol_AC_ssns_allage_eur.txt"), 
            row.names=FALSE, quote=FALSE, col.names = TRUE)

bristol_AC <- read.table(paste0(dir, "bristol/AF/",  disease_subtype,  "/", ancestry,  "/bristol_AC_ssns_allage_eur.txt"), header = TRUE) %>% 
...
clump_bristol <- read.table(paste0(dir, "bristol/AF/", disease_subtype, "/", ancestry, "/clump_bristol_1899.clumped"), header = TRUE) 
nrow(clump_bristol)
...
snp_list = c("6:32663671", "6:32669238")
